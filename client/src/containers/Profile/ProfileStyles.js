...
const profileStyles = createUseStyles({
  ...
  /* ----------- Google Pixel ----------- */
  /* Portrait */
  "@media screen and (width: 360px) and (height: 640px) and (-webkit-min-device-pixel-ratio: 3)": {
    Info: {
      width: "90%",
      height: "65%"
    },
  ...
  /* Landscape */
  "@media screen and (width: 640px) and (height: 360px) and (-webkit-min-device-pixel-ratio: 3)": {
    Info: {
      width: "90%",
      height: "75%",
      margin: "90px auto 0 auto",
  ...
  /* ----------- Google Pixel XL ----------- */
  /* Portrait */
  "@media screen and (width: 360px) and (height: 640px) and (-webkit-min-device-pixel-ratio: 4)": {
    Info: {
      width: "90%",
      height: "60%",
    },
